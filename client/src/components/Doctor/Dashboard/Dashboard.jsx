      ...
      <div className="mt-6 flex flex-1 flex-col justify-between">
        <nav className="-mx-3 space-y-6 ">
          <div className="space-y-3 ">
            <label className="px-3 text-xs font-semibold uppercase text-white">Time Slots</label>
            <button
            ...
            >
              ...
              <Link className="text-left w-full mx-2 text-sm font-medium" to="add-timeslot">Add TimeSlot</Link>
            </button>
            <button
            ...
            >
              ...
              <Link className="text-left w-full mx-2 text-sm font-medium" to="manage-timeslot">Manage TimeSlot</Link>
            </button>
          </div>
          <div className="space-y-3 ">
            <label className="px-3 text-xs font-semibold uppercase text-white">Appointments</label>
            <button
              className="w-full flex transform items-center rounded-lg px-3 py-2 text-gray-200 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
              type="button"
            >
              <Newspaper className="h-5 w-5" aria-hidden="true" />
              <Link className="text-left w-full mx-2 text-sm font-medium" to="appointment-table">Normal Appointment</Link>
            </button>
            <button
          ...
          <div className="space-y-3 ">
            ...
            >
              ...
              <Link className="text-left w-full mx-2 text-sm font-medium" to="profile">Profile</Link>
            </button>
            <button
              className="w-full flex transform items-center rounded-lg px-3 py-2 text-gray-200 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
              type="button"
            ...
            >
              ...
              <Link className="text-left w-full mx-2 text-sm font-medium">Logout</Link>
            </button>
          </div>
        </nav>
      </div>
