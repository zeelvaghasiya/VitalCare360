...
function Footer() {
  return (
    <section className="relative overflow-hidden bg-blue-400 py-8">
      <div className="container relative z-10 mx-auto px-4">
        <div className="-m-8 flex flex-wrap items-center justify-between">
          <div className="w-auto p-8">
            <Link to="/">
              <div className="inline-flex items-center">
                <span className="ml-4 text-2xl font-bold text-white">vitalCare360</span>
              </div>
            </Link>
          </div>
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5">
                <a className="font-medium text-black hover:text-white" href="#">
                  Privacy Policy
                </a>
              </li>
              <li className="p-5">
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <a href="#">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-black hover:border-white">
                    <svg
                      width="8"
                      height="14"
                      viewBox="0 0 8 14"
